...
jc({
  ...
  methods: [
    ...
    { signature: 'static int compare(int[] a, int[] b) / mismatch(int[] a, int[] b)', desc: 'Lexicographic compare; mismatch returns the first differing index, the shorter length if one is a proper prefix, or -1 if fully equal.' },
